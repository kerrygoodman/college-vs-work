...
with st.form("add_scenario_form"):
    ...
    loan_interest_rate = st.number_input("Loan interest rate (e.g., 0.05 for 5%)", min_value=0.0000, max_value=1.0000, value=0.0005, step=0.0001)
    ...
    salary_growth_rate = st.number_input("Annual salary growth rate (e.g., 0.03 for 3%)", min_value=0.0000, max_value=1.0000, value=0.0003, step=0.00001)
